...
PagingHolder.prototype.init_panel_config = function( panel_config ) {
    ...
    /*默认搜索*/
    // paging_holder.panel_config.is_default_search = panel_config.is_default_search !== undefined ? panel_config.is_default_search : false;
    paging_holder.panel_config.is_default_search = false;
    ...
    /*检查输入正确与否的工具*/
    paging_holder.check_tool.prototype = Object.create(ChinArk_forms.prototype);
    paging_holder.check_tool.prototype.constructor = ChinArk_forms 
    paging_holder.search_check_tool.prototype = Object.create(ChinArk_forms.prototype);
    paging_holder.search_check_tool.prototype.constructor = ChinArk_forms
...
PagingHolder.prototype.load_data_into_main_body = function() {
    ...
    $("#"+paging_holder.panel_body_id +' tr').removeClass('background-checked background-hovered');
}
