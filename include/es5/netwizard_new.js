...
var Netwizard = function (_mix) {
    ...
    _createClass(Netwizard, [{
        ...
        value: function buildHtml() {
            var step = this.createStep(this.getObjSize(this.interfaceConfig.stepdetail));
    ...
    return Netwizard;
}(mix(_create2.default, _animate2.default, _common2.default, _base2.default));
...
var Create = function () {
	...
	_createClass(Create, [{
		...
		value: function createStepPanel(data) {
			var self = this;
			var content = "数据有误";
			var contentData = data.stepdetail['step' + data.step];
			var panel = {
...
var Animate = function () {
	...
	_createClass(Animate, [{
		key: 'slideShow',
		value: function slideShow(el, effect) {
			(0, _jquery2.default)(el).removeClass().addClass(effect + ' animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function () {
